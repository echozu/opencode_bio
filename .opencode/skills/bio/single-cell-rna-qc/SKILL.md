...
description: Perform quality control on single-cell RNA-seq data (.h5ad, 10x .h5, or 10x directories) using scverse best practices, MAD-based filtering (log1p counts/genes, high-tail MT%), and generate filtered An
metadata:
  author: unknown
  source: https://skillsmp.com/skills/mdbabumiamssm-llms-universal-life-science-and-clinical-skills-skills-external-collections-life-sciences-claudeai-main-single-cell-rna-qc-skill-md
---
