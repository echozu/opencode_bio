...
This step dispatches THREE specialist agents to deliberate on the research question through the `multi-round-deliberation` protocol (max 5 rounds). This is NOT optional.
</IRON-LAW>
