...
- `experiment-execution` for Phase 4 orchestration
- `results-verification-protocol` before claiming completion
- `results-integration` when consolidating outputs
...
- `claim-evidence-alignment` (if claims are being prepared for reporting/writing)
