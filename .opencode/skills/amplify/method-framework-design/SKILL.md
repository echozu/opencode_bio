...
**REQUIRED SUB-SKILL:** Invoke `evaluation-protocol-design` if available. If unavailable, follow the procedure below.
...
After Round 1, follow `multi-round-deliberation`:
...
**REQUIRED SUB-SKILL:** Invoke `analysis-storyboard-design` before finalizing the Type D plan. If unavailable, follow the D-Step process below manually.
